...
old_logic = """btc_ret = self.market_trend.get('btc_4h_return', 0.0)
...
new_logic = """btc_ret = self.market_trend.get('btc_24h_return', 0.0)
...
code = re.sub(re.escape(old_logic), new_logic, code)
